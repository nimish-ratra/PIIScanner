...
function LoginForm() {
  ...
  const handleSubmit = async (e?: React.SyntheticEvent) => {
    ...
    try {
      ...
      const rawDest = redirectTo ? decodeURIComponent(redirectTo) : '/dashboard';
...
export default function LoginPage() {
  return (
    <React.Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-zinc-950 text-white text-sm">
        Loading…
      </div>
    }>
      <LoginForm />
