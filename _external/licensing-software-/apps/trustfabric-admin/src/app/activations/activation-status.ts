 ...
 * only — the backend is the actual enforcer. Vendor scope only ever drives
 * SUSPENDED/ACTIVE/REVOKED (see VendorActivationsController) — PENDING->ACTIVE
 * is the agent's own registration, never vendor- or customer-initiated.
 */
