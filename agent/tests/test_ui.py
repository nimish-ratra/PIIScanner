...
class TestUI(unittest.TestCase):
    ...
    def test_05_live_scan_via_ui(self):
        ...
        self.assertGreater(self.window.view_scan._total_findings, 0)
    ...
    def test_07_pii_entity_selection_persistence_and_sync(self):
        ...
        self.assertEqual(scan_view.lbl_selected_count.text().lower(), f"2 of {total_ents} types active")
        ...
        self.assertEqual(scan_view.lbl_selected_count.text().lower(), f"3 of {total_ents} types active")
        ...
        self.assertEqual(scan_view.lbl_selected_count.text().lower(), f"all {total_ents} types active")
