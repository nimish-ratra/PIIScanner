...
class LogViewer(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        self.lbl_title_icon.setPixmap(get_icon("monitor", "#64748B", 14).pixmap(14, 14))

        self.lbl_title = QLabel("Live Activity & Audit Log", self)
        self.lbl_title.setStyleSheet("font-weight: 700; font-size: 12px;")

        self.btn_toggle = QPushButton("Minimize Log", self)
        self.btn_toggle.setIcon(get_icon("chevron-down", "#3f3f46", 14))
    ...
    def expand(self) -> None:
        """Ensure the console is visible, e.g. before scrolling it into view."""
