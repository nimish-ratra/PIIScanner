"""
Scan History View for CLAISSIFY
...
class HistoryView(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        self.btn_refresh.setIcon(get_icon("refresh-cw", "#3f3f46", 16))
        ...
        self.tabs.addTab(tab_scans, get_icon("folder", "#64748B", 16), "Directory Scans")
        ...
        self.edit_enf_search.addAction(get_icon("search", "#94A3B8", 16), QLineEdit.LeadingPosition)
        ...
        self.btn_export_enf_csv.setIcon(get_icon("download", "#3f3f46", 16))
        ...
        self.btn_inspect_enf = QPushButton("Inspect Event Details...", tab_enforcement)
        self.btn_inspect_enf.setIcon(get_icon("eye", "#3f3f46", 16))
        ...
        self.tabs.addTab(tab_enforcement, get_icon("shield", "#64748B", 16), "Real-Time Enforcement Events")
    ...
    def refresh_history(self) -> None:
        ...
        for row_idx, scan in enumerate(self.scans):
            ...
            is_full_system = scan.get("scan_source") == "full_system_scan"
            display_target = f"[Full System] {target_str}" if is_full_system else target_str
            item_folder = QTableWidgetItem(display_target)
            item_folder.setIcon(get_icon("monitor" if is_full_system else "folder", "#64748B", 14))
    ...
    def refresh_enforcement(self) -> None:
        ...
        for row_idx, ev in enumerate(self.enforcement_events):
            ...
            item_tier.setIcon(QIcon(dot_pixmap(color_hex, 10)))
