...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "java_path": "",
    "tesseract_path": "",
    # TrustFabric licensing backend. Empty string here means "use the
    # PIISENTINEL_LICENSE_BACKEND_URL env var, or the local dev default" —
    # see backend/license_client.py:get_backend_url(). The installer sets this
